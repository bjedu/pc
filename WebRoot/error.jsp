...
<script type="text/javascript" src="<%=path%>/common/js/plugins/jquery-1.7.min.js"></script>
<script type="text/javascript" src="<%=path%>/common/js/plugins/jquery-ui-1.8.16.custom.min.js"></script>
<script type="text/javascript" src="<%=path%>/common/js/plugins/jquery.cookie.js"></script>
...
<div class="userdata">
                    ...
                    <span class="email">useless@***.com</span>
                    <ul>
    ...
    <div class="contentwrapper padding10">
    	<div class="errorwrapper error403">
        	<div class="errorcontent">
                ...
                <p>Please contact the server administrator <strong>useless@***.com</strong> and informed them of the time the error occurred.<br /> More information about this error may be available in the server error log.</p>
                <br />
